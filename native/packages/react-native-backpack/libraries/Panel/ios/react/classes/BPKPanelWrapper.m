...
- (instancetype)initWithFrame:(CGRect)frame bridge:(nonnull RCTBridge *)bridge {
...
/*    CGSize size = [[self.bridge.uiManager viewForReactTag:self.reactTag] systemLayoutSizeFittingSize:UILayoutFittingCompressedSize];
